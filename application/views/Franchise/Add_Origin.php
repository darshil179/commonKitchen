                ...
                <div class="page-breadcrumb border-bottom">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                            <h5 class="font-medium text-uppercase mb-0"><?php echo $owner->Owner_Name ?></h5>
                        </div>
                ...
                <div class="page-content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="card">
                                <form method="POST" action="<?php echo base_url(); ?>Franchise/Franchise_Controller/AddOrigin">
                                    <div class="card-body">
                                        <h4 class="card-title">Add New Origins</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Origin Pin-Codes</label>
                                                    <input type="text" class="form-control" id="franchise_name" name="origins" placeholder="Origin Pin-Codes">
