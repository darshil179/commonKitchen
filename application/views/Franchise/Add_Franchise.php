                ...
                <div class="page-content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="card">
                                <form method="POST" action="<?php echo base_url(); ?>Franchise/Franchise_Controller/AddFranchise">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="franchise_name" name="franchise_name" placeholder="Owner Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Owner Email</label>
                                                    <input type="text" class="form-control" id="franchise_email" name="franchise_email" placeholder="Owner Email">
                                                </div>
                                                <div class="form-group">
