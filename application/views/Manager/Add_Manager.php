                ...
                <div class="page-content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="card">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>Manager/Manager_Controller/Addmanager">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="" class="form-control" id="inputname" name="manager_name" placeholder="Manager Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Manager Email</label>

                                                    <input type="email" value="" class="form-control" id="inputname" name="manager_email" placeholder="Manager Email">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Manager Mobile</label>

                                                    <input type="text" value="" class="form-control" id="inputname" name="manager_mobile" placeholder="Manager Mobile">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Address</label>

                                                    <input type="text" value="" class="form-control" id="inputname" name="manager_address" placeholder="Address">
                                                </div>
                                            </div>
