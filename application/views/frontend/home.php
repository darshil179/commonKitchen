...
<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="<?php echo base_url('frontend/commonkitchen/assets/images/logo/favicon.png'); ?>" type="image/x-icon">

        <!-- CSS Files -->
        <link rel="stylesheet" href="<?php echo base_url('frontend/commonkitchen/assets/css/animate-3.7.0.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url('frontend/commonkitchen/assets/css/font-awesome-4.7.0.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url('frontend/commonkitchen/assets/css/bootstrap-4.1.3.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url('frontend/commonkitchen/assets/css/owl-carousel.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url('frontend/commonkitchen/assets/css/jquery.datetimepicker.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url('frontend/commonkitchen/assets/css/style.css'); ?>">
    </head>
    <body>
        <!-- Preloader Starts -->
        <div class="preloader">
        ...
        <header class="header-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2">
                        <div class="logo-area">
                            <a href="index.html"><img src="<?php echo base_url('frontend/commonkitchen/assets/images/logo/logo.png'); ?>" alt="logo"></a>
                        </div>
                    </div>
                    <div class="col-lg-10">
                        ...
                        <div class="main-menu">
                            <ul>
                                ...
                                <li><a href="<?php echo base_url(); ?>menu_frontend">menu</a></li>
                                <!-- <li><a href="#">blog</a>
                                    <ul class="sub-menu">
                                        <li><a href="<?php echo base_url(); ?>blog">Blog Home</a></li>
                                        <li><a href="<?php echo base_url(); ?>blogdetail">Blog Details</a></li>
                                    </ul>
                                </li> -->
                                <li><a href="<?php echo base_url(); ?>contact">contact</a></li>
                                <!-- <li><a href="<?php echo base_url(); ?>element">Elements</a></li> -->
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1>Discover the <span class="prime-color">flavors</span><br>  
                            <span class="style-change">of <span class="prime-color">Common</span>Kitchen</span></h1>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <div class="welcome-img">
                            <img src="<?php echo base_url('frontend/commonkitchen/assets/images/welcome-bg.png'); ?>" class="img-fluid" alt="">
                        </div>
                    </div>
                    <div class="col-md-6 align-self-center">
                        <div class="welcome-text mt-5 mt-md-0">
                            <h3><span class="style-change">welcome</span> <br>to common kitchen</h3>
                            ...
                            <div class="categories_post">
                                ...
                                <div class="categories_details">
                                    <div class="categories_text">
                                        <a href="<?php echo base_url(); ?>single_category/<?php echo $row->Cat_ID ?>"><h5><?php echo $row->Cat_Name ?></h5></a>
                        ...
                        <div class="testimonial-slider owl-carousel">
                            <div class="single-slide d-sm-flex">
                                <div class="customer-img mr-4 mb-4 mb-sm-0">
                                    <img src="<?php echo base_url('frontend/commonkitchen/assets/images/customer1.png'); ?>" alt="">
                                </div>
                            ...
                            <div class="single-slide d-sm-flex">
                                <div class="customer-img mr-4 mb-4 mb-sm-0">
                                    <img src="<?php echo base_url('frontend/commonkitchen/assets/images/customer2.png'); ?>" alt="">
                                </div>
                                <div class="customer-text">
                                    <h5>adam nahan</h5>
                                    <span><i>Chief Customer</i></span>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="single-food">
                            <div class="food-img">
                                <img src="<?php echo base_url('frontend/commonkitchen/assets/images/update1.jpg'); ?>" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="single-food my-5 my-md-0">
                            <div class="food-img">
                                <img src="<?php echo base_url('frontend/commonkitchen/assets/images/update2.jpg'); ?>" class="img-fluid" alt="">
                            </div>
                            <div class="food-content">
                                <div class="post-admin d-lg-flex mb-3">
                                    <span class="mr-5 d-block mb-2 mb-lg-0"><i class="fa fa-user-o mr-2"></i>Admin</span>
                    ...
                    <div class="col-md-4">
                        <div class="single-food">
                            <div class="food-img">
                                <img src="<?php echo base_url('frontend/commonkitchen/assets/images/update3.jpg'); ?>" class="img-fluid" alt="">
                            </div>
                            <div class="food-content">
                                <div class="post-admin d-lg-flex mb-3">
                                    <span class="mr-5 d-block mb-2 mb-lg-0"><i class="fa fa-user-o mr-2"></i>Admin</span>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="single-widget single-widget1">
                                <a href="index.html"><img src="<?php echo base_url('frontend/commonkitchen/assets/images/logo/logo2.png'); ?>" alt=""></a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-md-6">
                            <span>
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All Rights Reserved by Common Kitchen. Designed and Developed by
                                <a href="http://www.assertionit.com/">AssertionIT</a>.
                            </span>
                        </div>
        ...
        <script src="<?php echo base_url('frontend/commonkitchen/assets/js/vendor/jquery-2.2.4.min.js'); ?>"></script>
        <script src="<?php echo base_url('frontend/commonkitchen/assets/js/vendor/bootstrap-4.1.3.min.js'); ?>"></script>
        <script src="<?php echo base_url('frontend/commonkitchen/assets/js/vendor/wow.min.js'); ?>"></script>
        <script src="<?php echo base_url('frontend/commonkitchen/assets/js/vendor/owl-carousel.min.js'); ?>"></script>
        <script src="<?php echo base_url('frontend/commonkitchen/assets/js/vendor/jquery.datetimepicker.full.min.js'); ?>"></script>
        <script src="<?php echo base_url('frontend/commonkitchen/assets/js/vendor/jquery.nice-select.min.js'); ?>"></script>
        <script src="<?php echo base_url('frontend/commonkitchen/assets/js/main.js'); ?>"></script>
    </body>
</html>
