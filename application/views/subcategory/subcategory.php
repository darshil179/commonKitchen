                ...
                <div class="page-breadcrumb border-bottom">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                            <a href="<?php echo base_url(); ?>addsubcategory" class="btn btn-danger text-white float-right ml-3 d-md-block">Add New SubCategory</a>
                                            ...
                                            <tbody>
                                                <?php foreach ($subcategory_list as $row): ?>
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-outline-info btn-circle btn-lg btn-circle ml-2" href="<?php echo base_url(); ?>edit_subcategory/<?php echo $row->Subcategory_Id ?>"><i class="ti-pencil"></i></a>
                                                            <a class="btn btn-outline-info btn-circle btn-lg btn-circle ml-2" href="<?php echo base_url(); ?>delete_subcategory/<?php echo $row->Subcategory_Id ?>"><i class="ti-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
