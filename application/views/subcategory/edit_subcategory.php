                ...
                <div class="page-content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="card">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>subcategory/Subcategory_Controller/Editsubcategory">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select mr-sm-2" required="" name="cat_id" id="inlineFormCustomSelect">
                                                        ...
                                                        <?php foreach ($category_list as $row): ?>
                                                            <?php if ($row->Cat_ID == $subcategory->Category_Id) { ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo $subcategory->Subcategory_Name ?>" class="form-control" id="inputname" name="sub_name" placeholder="Product Name">
                                                    <input type="hidden" value="<?php echo $subcategory->Subcategory_Id ?>" name="sub_id">
                                                </div>
                                            </div>
