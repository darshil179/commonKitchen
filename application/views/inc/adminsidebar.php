            ...
            <ul id="sidebarnav">
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark profile-dd" href="javascript:void(0)" aria-expanded="false">
                        ...
                        <span class="hide-menu"><?php echo $this->session->userdata('FullName'); ?></span>
                    </a>
                ...
                <?php if ($this->session->userdata('RoleId') == '1') {
                    ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark" href="<?php echo base_url(); ?>category" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark" href="<?php echo base_url(); ?>subcategory" aria-expanded="false">
                            <i class="mdi mdi-cart-outline"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark" href="<?php echo base_url(); ?>menu" aria-expanded="false">
                            <i class="mdi mdi-cart-outline"></i>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="<?php echo base_url(); ?>package" class="sidebar-link">
                                    <i class="mdi mdi-toggle-switch"></i>
                                    <span class="hide-menu">Package List</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo base_url(); ?>package_item" class="sidebar-link">
                                    <i class="mdi mdi-tablet"></i>
                                    <span class="hide-menu">Package Item</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo base_url(); ?>package_restriction" class="sidebar-link">
                                    <i class="mdi mdi-sort-variant"></i>
                                    <span class="hide-menu">Package Restriction</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo base_url(); ?>today_package" class="sidebar-link">
                                    <i class="mdi mdi-sort-variant"></i>
                                    <span class="hide-menu">Today's Package</span>
                                </a>
                            </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark" href="<?php echo base_url(); ?>franchise" aria-expanded="false">
                            <i class="mdi mdi-cart-outline"></i>
                            <span class="hide-menu">Franchise List</span>
                        </a>

                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark" href="<?php echo base_url(); ?>usermanagement" aria-expanded="false">
                            <i class="mdi mdi-cart-outline"></i>
                ...
                <?php if ($this->session->userdata('RoleId') == '3') {
                    ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark" href="<?php echo base_url(); ?>delivery" aria-expanded="false">
                            <i class="mdi mdi-cart-outline"></i>
                            <span class="hide-menu">Delivery List</span>
                        </a>
                ...
                <!--                <li class="sidebar-item">
                                ...
                                <div class="devider"></div>
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.ampleadmin.wrappixel.com/docs/documentation.html" aria-expanded="false">
