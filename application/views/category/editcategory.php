                ...
                <div class="page-breadcrumb border-bottom">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                            <h5 class="font-medium text-uppercase mb-0">Category Edit</h5>
                        </div>
                ...
                <div class="page-content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="card">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>Category/Category_Controller/EditCategory">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="inputname" value="<?php echo $category->Cat_Name ?>" name="cname" placeholder="Category Name">
                                                    <input type="hidden" name="cat_id" value="<?php echo $category->Cat_ID ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Category Short Description</label>
                                                    <input maxlength="40" value="<?php echo $category->Cat_Description ?>" type="text" class="form-control" id="inputname" name="cdescription" placeholder="Category Description">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" value="<?php echo $category->Cat_Image ?>" class="custom-file-input" name="img" id="inputGroupFile01">
                                        ...
                                        <div class="action-form">
                                            <div class="form-group mb-0 text-left">
                                                <button type="submit" class="btn btn-info waves-effect waves-light" name="submit">Update</button>
