                ...
                <div class="page-content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="card">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>Chef/Chef_Controller/EditChef">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo $Chef->Chef_Name ?>" class="form-control" id="inputname" name="chef_name" placeholder="Chef Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Chef Email</label>

                                                    <input disabled="" type="email" value="<?php echo $Chef->Chef_Email ?>" class="form-control" id="inputname" name="chef_email" placeholder="Chef Email">
                                                    <input type="hidden" name="chef_email" value="<?php echo $Chef->Chef_Email ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Chef Mobile</label>

                                                    <input type="text" value="<?php echo $Chef->Chef_Mobile ?>" class="form-control" id="inputname" name="chef_mobile" placeholder="Chef Mobile">
...
<!--                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo $Chef->Manager_Name ?>" class="form-control" id="inputname" name="chef_address" placeholder="Address">
                                                </div>-->
                                            </div>
