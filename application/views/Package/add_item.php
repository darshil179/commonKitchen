                ...
                <div class="page-content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="card">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>Package/Package_Controller/Additem">
                                    <div class="card-body">
                                        <h4 class="card-title">Add New Package Item</h4>
...
<!--                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="inputname" name="iname" placeholder="Item Name">
                                                </div>
<!--                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="inputname" name="quantity" placeholder="Item Quantity">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Price</label>

                                                    <input type="text" class="form-control" id="inputname" name="price" placeholder="Item Price">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" name="item_img" id="inputGroupFile01">
