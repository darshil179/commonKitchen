                ...
                <div class="page-breadcrumb border-bottom">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                            <a href="<?php echo base_url(); ?>add_package" class="btn btn-danger text-white float-right ml-3 d-md-block">Add New Package</a>
                                            ...
                                            <tbody>
                                                <?php foreach ($package_list as $row): ?>
                                                    <tr>
                                                        ...
                                                        <td><img style="width: 100px;" src="<?php echo base_url() ?>images/packageImage/<?php echo $row->Package_name; ?>/<?php echo $row->Package_Img ?>"></td>
                                                        <td><?php echo $row->Price ?></td>
                                                        <td><a class="btn btn-outline-info btn-circle btn-lg btn-circle ml-2" href="<?php echo base_url(); ?>editpackage/<?php echo $row->Package_Id ?>"><i class="ti-pencil"></i></a>
                                                            <a class="btn btn-outline-info btn-circle btn-lg btn-circle ml-2" href="<?php echo base_url(); ?>deletepackage/<?php echo $row->Package_Id ?>"><i class="ti-trash"></i></a>
                                                        </td>
                                                        <td><a class="btn btn-outline-info btn-circle btn-lg btn-circle ml-2" href="<?php echo base_url(); ?>addt/<?php echo $row->Package_Id ?>"><i class="ti-menu"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
