                ...
                <div class="page-breadcrumb border-bottom">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                            <a href="<?php echo base_url(); ?>add_package" class="btn btn-danger text-white float-right ml-3 d-md-block">Add Today's Package</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="default_order" class="table table-striped border display" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php foreach ($GetAllPackageProducts as $row): ?>
                                                    <tr>
                                                        <td><?php echo $row->Package_name ?></td>
                                                        <td><?php echo $row->Product_Name ?></td>
                                                        <td><?php echo $row->Package_info ?></td>
                                                        <td><img style="width: 100px;" src="<?php echo base_url() ?>images/packageImage/<?php echo $row->Package_Img; ?>/<?php echo $row->Package_Img ?>"></td>
                                                        <td><?php echo $row->PackagePrice ?></td>
                                                        <!--<td><?php echo $row->Product_Name ?></td>-->

                                                        <td><a class="btn btn-outline-info btn-circle btn-lg btn-circle ml-2" href="<?php echo base_url(); ?>edit_today_package/<?php echo $row->Today_Id ?>"><i class="ti-pencil"></i></a>
                                                            <a class="btn btn-outline-info btn-circle btn-lg btn-circle ml-2" href="<?php echo base_url(); ?>delete_today_package/<?php echo $row->Today_Id ?>"><i class="ti-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
