                ...
                <div class="page-breadcrumb border-bottom">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                            <a href="<?php echo base_url(); ?>category/Category_Controller/Add_category" class="btn btn-danger text-white float-right ml-3 d-none d-md-block">Add New Category</a>
