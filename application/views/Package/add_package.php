                ...
                <div class="page-content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="card">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>Package/Package_controller/AddPackage">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 col-md-9">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="inputname" name="pname" placeholder="Package Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Package Information</label>

                                                    <input type="text" class="form-control" id="inputname" name="pinfo" placeholder="Package Information">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="inputname" class="control-label col-form-label">Package Image</label>
