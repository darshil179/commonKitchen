                ...
                <div class="page-content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="card">
                                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>Delivery/Delivery_Controller/AddDelivery">
                                    <div class="card-body">
                                        <h4 class="card-title">Add New Delivery Person</h4>
                                        <div class="row">
                                            <div class="col-sm-4 col-md-9">
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Delivery Person Name</label>

                                                    <input type="text" value="" class="form-control" id="inputname" name="del_name" placeholder="Delivery Person Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Delivery Person Email</label>

                                                    <input type="email" value="" class="form-control" id="inputname" name="del_email" placeholder="Delivery Person Email">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Delivery Person Mobile</label>

                                                    <input type="text" value="" class="form-control" id="inputname" name="del_mobile" placeholder="Delivery Person Mobile">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputname" class="control-label col-form-label">Delivery Person Address</label>

                                                    <input type="text" value="" class="form-control" id="inputname" name="del_address" placeholder="Delivery Person Address">
                                                </div>
<!--                                                <div class="form-group">
